    ...
    <div id="api-docs-view" className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            <span className="px-2.5 py-0.5 rounded text-[11px] font-mono bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-bold">
              OPENAPI 3.0.3 SPECIFICATION
            </span>
            <span className="px-2.5 py-0.5 rounded text-[11px] font-mono bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 font-bold">
              RESTful ARCHITECTURE
            </span>
            <span className="text-xs text-slate-400 font-mono">• Production Engine</span>
          </div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Interactive Swagger & API Documentation</h1>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold flex items-center gap-1.5 shadow-sm transition"
          >
          ...
          <div className="flex bg-slate-950 p-1 rounded-xl border border-slate-800">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition ${
                viewMode === 'interactive' ? 'bg-slate-800 text-white shadow-xs' : 'text-slate-400 hover:text-slate-200'
              }`}
            >
              Interactive UI
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition ${
                viewMode === 'reference' ? 'bg-slate-800 text-white shadow-xs' : 'text-slate-400 hover:text-slate-200'
              }`}
            >
              Quick Reference
            </button>
      ...
      {viewMode === 'interactive' ? (
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-xs overflow-hidden">
          ...
          {/* cURL Example */}
          <div className="p-4 bg-slate-950 text-slate-200 border-t border-slate-800">
            ...
            <pre className="text-xs font-mono text-emerald-400 overflow-x-auto p-3 bg-slate-900 rounded-lg border border-slate-800">
